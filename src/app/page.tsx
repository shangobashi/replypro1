...
export default function Home() {
  ...
  return (
    <div className="min-h-screen bg-background text-foreground">
      {/* Navigation */}
      <nav className="fixed top-0 w-full bg-background/90 backdrop-blur-xl z-50 border-b border-border">
      ...
      <section className="pt-32 pb-24 px-6">
        <div className="max-w-3xl mx-auto text-center">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <Button asChild size="lg" className="glow-button rounded-full px-8 bg-primary hover:bg-primary/90 text-primary-foreground shadow-lg shadow-primary/25">
              <Link href="/signup">
                Start free trial
      ...
      <section id="demo" className="py-24 px-6">
        <div className="max-w-5xl mx-auto">
          ...
          <div className="grid md:grid-cols-2 gap-6">
            <Card className="animate-card bg-card border-border overflow-hidden">
            ...
            <Card className="animate-card bg-card border-primary/30 overflow-hidden shadow-lg shadow-primary/10">
              <CardContent className="p-6">
                <div className="flex items-center gap-2 mb-4">
      ...
      <section className="py-24 px-6">
        <div className="max-w-5xl mx-auto">
          ...
          <div className="grid md:grid-cols-3 gap-6">
            <Card className="animate-card bg-card border-border text-center p-6">
      ...
      <section id="pricing" className="py-24 px-6">
        <div className="max-w-4xl mx-auto">
          ...
          <div className="grid md:grid-cols-2 gap-6 max-w-3xl mx-auto">
            <Card className="animate-card bg-card border-border p-8">
              ...
              <Button asChild variant="outline" className="w-full mt-8 rounded-full border-border hover:bg-secondary">
                <Link href="/signup">Get started</Link>
              </Button>
            </Card>

            <Card className="animate-card bg-card border-primary/30 p-8 relative shadow-lg shadow-primary/10">
              ...
              <Button asChild className="glow-button w-full mt-8 rounded-full bg-primary hover:bg-primary/90 text-primary-foreground">
      ...
      <section className="py-24 px-6">
        <div className="max-w-5xl mx-auto">
          ...
          <div className="grid md:grid-cols-3 gap-6">
            <Card className="animate-card bg-card border-border p-6">
      ...
      <footer className="py-12 px-6 border-t border-border">
        <div className="max-w-5xl mx-auto">
          ...
          <div className="text-center mt-8 text-sm text-muted-foreground">
            <p>ReplyPro by <span className="font-medium text-foreground">BLUELABS</span></p>
